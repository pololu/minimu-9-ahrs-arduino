...
To ensure that the heading derived from the compass is accurate, you should change the @M_X_MIN@ through @M_Z_MAX@ calibration constants to appropriate values. You can use the Calibrate example from the "LSM303 library":https://github.com/pololu/LSM303 to find the right values for the board.
